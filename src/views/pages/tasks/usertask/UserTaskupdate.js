...
const UserTaskupdate = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:8800/userstask/'+ id)
      .then(res => {
  ...
  const handleUpdate = (e) => {
    e.preventDefault();
    axios.put("http://localhost:8800/userstask/"+id, { taskName, taskPerson, projectName,taskStatus,taskNote, taskDesc, asssignDate, completeDate } )
            .then(res => {
              //  console.log(res.data);
              navigate("/getuserstask");
     })
}
      ...
      <CRow className="mb-3">
         ...
         <CRow className="mt-4">
            <CCol className="mb-3 d-flex justify-content-center">
               ...
               <Link to={'/getuserstask'}><CButton style={{ width: '10rem',color:'white' }} color="danger">Cancel</CButton></Link>
            </CCol>
         </CRow>
      </CForm>
   </CCardBody>
